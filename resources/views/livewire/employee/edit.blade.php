<div>
    <x-page-title title="Edit Employee"></x-page-tile>
        ...
        <x-form.main>
            ...
            <x-slot name="body">
                <x-form.group>
                    ...
                    <x-form.input type="text" wire:model="name" value="{{$employee->name}}"></x-form.input>
                </x-form.group>
                <x-form.group>
                    <x-form.label> Email* </x-form.label>
                    <x-form.input type="email" wire:model="email" value="{{$employee->email}}"></x-form.input>
                </x-form.group>
                <x-form.group>
                    <x-form.label> Phone* </x-form.label>
                    <x-form.input type="number" wire:model="phone" value="{{$employee->phone}}"></x-form.input>
                </x-form.group>
                <x-form.group>
