...
<div class="md:flex md:items-center md:justify-between bg-indigo-500 mb-2 py-5 px-2 border border-transparent rounded-md shadow-sm ">
    <div class="flex-1 min-w-0">
        <h2 class="text-2xl font-bold leading-7 text-white sm:text-3xl sm:truncate">{{$title}}</h2>
    </div>
